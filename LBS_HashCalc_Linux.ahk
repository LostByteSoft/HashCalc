...
;;	No icons at all in linux it's not supported.

;;	A version to use with WINE in Linux
...
;;--- Softwares Variables ---
	...
	SetEnv, version, Version 2018-04-10-1629
...
secret:
	MsgBox, 64, %title%, (Secret:) All variables is shown here.`n`ntitle=%title% mode=%mode% version=%version% author=%author% Debug=%debug%`n`nA_WorkingDir=%A_WorkingDir%`n`nClipboard (if text)=%clipboard%
	Return
